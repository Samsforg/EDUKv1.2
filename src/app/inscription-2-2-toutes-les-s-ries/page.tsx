...
<div className="relative">
<input checked={true} className="hidden" id="tab-general" name="serie-category" type="radio" />
<input className="hidden" id="tab-technique" name="serie-category" type="radio" />
<div className="tabs-nav flex border-b border-surface-border mb-6">
<label className="px-6 py-3 cursor-pointer font-label-md text-on-surface-variant hover:text-primary transition-colors" htmlFor="tab-general">ENSEIGNEMENT GÉNÉRAL</label>
<label className="px-6 py-3 cursor-pointer font-label-md text-on-surface-variant hover:text-primary transition-colors" htmlFor="tab-technique">ENSEIGNEMENT TECHNIQUE</label>
</div>
<div className="tabs-container">

<div className="tab-content grid grid-cols-2 sm:grid-cols-4 gap-3 animate-in fade-in duration-300" id="content-general">
<div className="relative">
<input checked={true} className="hidden custom-radio" id="serie-a1" name="serie" type="radio" value="A1" />
<label className="flex flex-col items-center justify-center p-4 border border-surface-border rounded-lg cursor-pointer transition-all hover:bg-surface-container-low active:scale-[0.98]" htmlFor="serie-a1">
<span className="font-metric-num text-metric-num text-primary">A1</span>
<span className="font-label-md text-label-md mt-1 text-on-surface-variant">Littéraire</span>
<span className="material-symbols-outlined absolute top-1 right-1 text-primary hidden check-icon text-[18px]" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
</label>
</div>
<div className="relative">
<input className="hidden custom-radio" id="serie-a2" name="serie" type="radio" value="A2" />
<label className="flex flex-col items-center justify-center p-4 border border-surface-border rounded-lg cursor-pointer transition-all hover:bg-surface-container-low active:scale-[0.98]" htmlFor="serie-a2">
<span className="font-metric-num text-metric-num text-primary">A2</span>
<span className="font-label-md text-label-md mt-1 text-on-surface-variant">Littéraire</span>
<span className="material-symbols-outlined absolute top-1 right-1 text-primary hidden check-icon text-[18px]" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
</label>
</div>
...
<label className="flex flex-col items-center justify-center p-4 border border-surface-border rounded-lg cursor-pointer transition-all hover:bg-surface-container-low active:scale-[0.98]" htmlFor="serie-c">
<span className="font-metric-num text-metric-num text-primary">C</span>
<span className="font-label-md text-label-md mt-1 text-on-surface-variant">Scientifique</span>
<span className="material-symbols-outlined absolute top-1 right-1 text-primary hidden check-icon text-[18px]" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
</label>
</div>
<div className="relative">
<input className="hidden custom-radio" id="serie-d" name="serie" type="radio" value="D" />
<label className="flex flex-col items-center justify-center p-4 border border-surface-border rounded-lg cursor-pointer transition-all hover:bg-surface-container-low active:scale-[0.98]" htmlFor="serie-d">
<span className="font-metric-num text-metric-num text-primary">D</span>
<span className="font-label-md text-label-md mt-1 text-on-surface-variant">SVT</span>
<span className="material-symbols-outlined absolute top-1 right-1 text-primary hidden check-icon text-[18px]" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
</label>
</div>
</div>

<div className="tab-content grid grid-cols-2 gap-3 animate-in fade-in duration-300" id="content-technique">
<div className="relative">
<input className="hidden custom-radio" id="serie-g2" name="serie" type="radio" value="G2" />
<label className="flex flex-col items-center justify-center p-4 border border-surface-border rounded-lg cursor-pointer transition-all hover:bg-surface-container-low active:scale-[0.98]" htmlFor="serie-g2">
<span className="font-metric-num text-metric-num text-primary">G2</span>
<span className="font-label-md text-label-md mt-1 text-on-surface-variant">Comptabilité</span>
...
<div className="relative">
<input className="hidden custom-radio" id="serie-b" name="serie" type="radio" value="B" />
<label className="flex flex-col items-center justify-center p-4 border border-surface-border rounded-lg cursor-pointer transition-all hover:bg-surface-container-low active:scale-[0.98]" htmlFor="serie-b">
<span className="font-metric-num text-metric-num text-primary">B</span>
<span className="font-label-md text-label-md mt-1 text-on-surface-variant">Technique</span>
<span className="material-symbols-outlined absolute top-2 right-2 text-primary hidden check-icon text-[20px]" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
</label>
</div>
</div>
