...
</div><div className="col-span-2 bg-surface-container-lowest p-5 rounded-xl border border-outline-variant shadow-sm space-y-3">
...
<div>
<p className="text-label-xs font-label-xs text-on-surface-variant uppercase tracking-wider">Ligue Académique</p>
<h3 className="font-headline-md text-headline-md text-on-surface">Ligue Argent</h3>
</div>
</div>
<div className="text-right">
<p className="text-label-sm font-label-sm text-primary font-bold">#14 dans Cocody</p>
<p className="text-label-xs font-label-xs text-on-surface-variant">Top 5%</p>
</div>
</div>
<div className="space-y-1.5">
<div className="flex justify-between items-end">
<span className="text-label-xs font-label-xs text-on-surface-variant">Progression vers Or</span>
<span className="text-label-sm font-label-sm text-on-surface font-bold">1,240 / 2,000 XP</span>
</div>
<div className="h-2 bg-outline-variant rounded-full overflow-hidden">
<div className="bg-secondary-container h-full w-[62%] rounded-full"></div>
</div>
</div>
</div>
