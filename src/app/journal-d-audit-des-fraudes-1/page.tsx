...
<span className="material-symbols-outlined text-on-primary" data-icon="security">security</span>
...
<span className="text-on-primary/80 font-medium cursor-pointer hover:bg-primary-container/20 transition-colors px-2 py-1 rounded">Alertes de fraude</span>
<span className="text-on-primary/80 font-medium cursor-pointer hover:bg-primary-container/20 transition-colors px-2 py-1 rounded">Investigations</span>
...
<img className="w-full h-full object-cover" src="/images/ecran-197.png" alt="Close up professional portrait of a West African male systems administrator in a modern office, sharp lighting, academic and high-tech atmosphere with soft blues and whites in the background, 8k resolution, cinematic style." />
</div>
</div>
</header>
...
<p className="text-xs text-on-surface-variant">Surveillance de la fraude</p>
</div>
</div>
...
<p className="text-on-surface-variant text-body-md">Tracking and monitoring administrative actions for academic integrity.</p>
</div>
...
<span className="text-xs font-medium">Last updated: 2 mins ago</span>
</div>
</div>
...
<label className="block text-xs font-semibold text-on-surface-variant mb-1.5 uppercase tracking-wider">Date Range</label>
...
<option>Compromission d'examen</option>
<option>Access Abuse</option>
</select>
</div>
</div>
<div className="flex-1 w-full md:w-auto">
...
<input className="w-full pl-10 pr-4 py-2.5 bg-surface border-outline-variant rounded-lg text-body-md focus:ring-2 focus:ring-primary focus:border-primary" placeholder="Filter log entries..." type="text" />
</div>
</div>
...
<h3 className="text-body-md font-bold text-primary mb-1">Account #8821 blocked</h3>
...
<h3 className="text-body-md font-bold text-primary mb-1">Refund request flagged for manual review</h3>
<div className="flex flex-wrap gap-2">
<span className="px-2 py-0.5 rounded bg-surface-container-high text-on-surface-variant text-[11px] font-medium flex items-center gap-1">
<span className="material-symbols-outlined text-[14px]" data-icon="gavel">gavel</span>
...
<h3 className="text-body-md font-bold text-primary mb-1">Adresse IP 192.168.1.45 mise sur liste noire</h3>
<div className="flex flex-wrap gap-2">
<span className="px-2 py-0.5 rounded bg-surface-container-high text-on-surface-variant text-[11px] font-medium flex items-center gap-1">
<span className="material-symbols-outlined text-[14px]" data-icon="gavel">gavel</span>
                                    Règle : BRUTE_FORCE_DETECTED
                                </span>
<span className="px-2 py-0.5 rounded bg-error-container text-on-error-container text-[11px] font-bold uppercase">Access Abuse</span>
</div>
</div>
</div>
<div className="flex items-center gap-4 border-t md:border-t-0 pt-4 md:pt-0 border-outline-variant/30">
...
<span className="px-2 py-0.5 rounded bg-tertiary-container text-on-tertiary-container text-[11px] font-bold uppercase">System Config</span>
</div>
</div>
</div>
<div className="flex items-center gap-4 border-t md:border-t-0 pt-4 md:pt-0 border-outline-variant/30">
<div className="text-right hidden sm:block">
<p className="text-[10px] text-on-surface-variant font-semibold uppercase">Impact Level</p>
...
<p className="text-sm text-on-surface-variant">Showing 1 to 10 of 254 entries</p>
<div className="flex items-center gap-2">
