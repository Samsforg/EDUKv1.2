...
<img alt="Edukora Logo" className="h-10 w-auto object-contain" src="/images/ecran-264.png" />
</div>
...
<h2 className="font-headline-md text-headline-md text-on-surface">Mes Objectifs de Série</h2>
</div>
...
<img alt="30 Day Streak Badge" className="w-full h-full object-contain" src="/images/ecran-003.png" />
</div>
<div className="flex-1">
<div className="flex justify-between items-end mb-2">
<div>
<p className="text-label-xs font-label-xs text-primary uppercase tracking-wider">Prochain Objectif</p>
<h4 className="font-body-lg text-body-lg font-bold text-on-surface">Série de 30 Jours</h4>
</div>
<span className="text-label-sm font-label-sm text-on-surface-variant">7/30 jrs</span>
</div>
<div className="h-2 bg-outline-variant rounded-full overflow-hidden">
<div className="bg-primary h-full w-[23%] rounded-full"></div>
</div>
<p className="text-label-xs font-label-xs text-on-surface-variant mt-2">Plus que 23 jours pour débloquer ce badge !</p>
</div>
</div>
