...
function getABVariant(): string {
  ...
  document.cookie = `edukora_ab_inscription=${variant};path=/;max-age=31536000;SameSite=Lax`;
  return variant;
}
...
function InscriptionPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    trackEvent(EVENTS.signupStarted, { role, method: email.trim() ? "email" : "phone", variant });
    try {
      ...
      <div className="min-h-dvh bg-surface text-on-surface flex flex-col items-center justify-center p-4 relative">
        ...
        <main className="w-full max-w-md bg-surface-container-lowest rounded-xl shadow-sm border border-surface-variant p-6 sm:p-8 flex flex-col">
          <header className="flex flex-col items-center text-center mb-8">
            ...
            <h1 className="font-headline-md text-3xl font-bold text-primary mb-2 tracking-tight">Rejoins des milliers d&apos;élèves</h1>
            <p className="text-on-surface-variant text-base">Fiches, quiz et tuteur IA — tout est gratuit.</p>
          </header>
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                <label htmlFor="firstName-b" className="block text-sm font-semibold text-on-surface">Prénom</label>
                <input
                  id="firstName-b"
                  type="text"
              ...
              <div className="space-y-1.5">
                <label htmlFor="lastName-b" className="block text-sm font-semibold text-on-surface">Nom</label>
                <input
                  id="lastName-b"
                  type="text"
            ...
            <div className="space-y-1.5">
              <label htmlFor="phone-b" className="block text-sm font-semibold text-on-surface">Téléphone <span className="text-error">*</span></label>
              <input
                id="phone-b"
                type="tel"
                inputMode="tel"
            ...
            <div className="space-y-1.5">
              <label htmlFor="password-b" className="block text-sm font-semibold text-on-surface">Mot de passe</label>
            ...
            {showExtraFields && role === "student" && (
              <>
                <div className="space-y-1.5">
                  <label htmlFor="email-b" className="block text-sm font-semibold text-on-surface">Email (optionnel)</label>
                  <input
                    id="email-b"
                    type="email"
                    autoComplete="email"
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="commune-b" className="block text-sm font-semibold text-on-surface">Commune</label>
                    <select
                      id="commune-b"
                      value={commune}
            ...
            <div className="space-y-1.5">
              <label htmlFor="referralCode-b" className="block text-sm font-semibold text-on-surface">Code de parrainage (optionnel)</label>
              <div className="relative">
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <label className="text-xs text-on-surface-variant leading-relaxed" htmlFor="acceptPrivacy-b">
                J&apos;accepte la{" "}
          ...
          <div className="mt-4 flex items-center justify-center gap-2 text-xs text-on-surface-variant">
            ...
            <span>Conforme au programme MENAET</span>
          </div>
  ...
  // Variant A — control (original form)
  return (
    <div className="min-h-dvh bg-surface text-on-surface flex flex-col items-center justify-center p-4 relative">
      <Link
        href="/"
