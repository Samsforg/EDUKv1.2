...
function ConnexionForm() {
  ...
  const labelClass =
    "pointer-events-none absolute top-3 left-4 text-base text-on-surface transition-all duration-200 " +
  ...
  return (
    <>
      ...
      <div className="relative flex items-center py-6">
        ...
        <span className="flex-shrink-0 mx-4 text-on-surface text-sm bg-surface-container-lowest px-2">Ou continuer avec</span>
        <div className="flex-grow border-t border-surface-variant"></div>
      </div>
      ...
      <div className="mt-8 text-center">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-1.5 text-xs font-medium text-on-surface hover:text-primary transition-colors"
        >
