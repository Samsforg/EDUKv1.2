...
<button className="w-10 h-10 flex items-center justify-center rounded-full text-primary hover:bg-surface-container-low transition-colors active:scale-95 duration-100"><div className="relative">
<span className="material-symbols-outlined">notifications</span>
<span className="absolute top-0 right-0 h-2.5 w-2.5 rounded-full bg-error border border-surface"></span>
</div></button>
</header>
<main className="pt-20 px-margin-mobile space-y-stack-lg"><div className="bg-inverse-surface text-inverse-on-surface p-4 rounded-xl shadow-md flex items-center gap-3 animate-in fade-in slide-in-from-top-4 duration-300">
<span className="material-symbols-outlined text-tertiary-fixed">verified</span>
<div className="flex-1">
<p className="text-label-sm font-bold">Analyse terminée</p>
<p className="text-label-xs opacity-90">Votre fiche sur les Logarithmes a été certifiée par Dr. Thorne !</p>
</div>
<button className="material-symbols-outlined text-[18px] opacity-70">close</button>
</div>
