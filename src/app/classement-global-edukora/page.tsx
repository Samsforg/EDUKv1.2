...
<h1 className="font-headline-md text-headline-md-mobile font-bold text-primary">Classement Global</h1>
</div>
<button className="p-2 hover:bg-surface-container-low transition-colors active:scale-95 duration-100 rounded-full">
...
<button className="flex-1 py-2 rounded-full font-label-sm text-label-sm transition-all bg-primary-container text-on-primary-container shadow-sm" id="toggle-streaks">
                    Séries (Streaks)
                </button>
<button className="flex-1 py-2 rounded-full font-label-sm text-label-sm transition-all text-on-surface-variant hover:bg-surface-container-high" id="toggle-score">
                    Score Global
                </button>
</div>
</div>
...
<div className="flex-1">
<p className="font-bold font-label-sm text-label-sm">Moi (Toi)</p>
<p className="text-[9px] opacity-80 uppercase tracking-tighter">Tu es dans le top 5% !</p>
</div>
