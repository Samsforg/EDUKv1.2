...
<span className="text-[10px] text-on-surface-variant uppercase tracking-wider">Série C</span>
</div>
...
<img className="w-full h-full object-cover rounded-full" src="/images/ecran-319.png" alt="A professional close-up portrait of a young West African male student with a focused and optimistic expression. He is wearing a clean, modern white polo shirt. The lighting is soft and natural, suggesting an academic environment. The background is slightly blurred with hints of a contemporary library, maintaining a clean light-mode aesthetic with soft blue and white tones." />
</div>
</div>
</header>
...
<p className="font-body-md text-body-md text-on-surface-variant max-w-xl">Sélectionnez une matière pour commencer votre simulateur d'examen en conditions réelles. Optimisé pour la série C.</p>
</div>

<div className="relative w-full md:w-96 group">
<span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-primary transition-colors">search</span>
<input className="w-full pl-12 pr-4 py-3 bg-surface border border-outline-variant rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all text-body-md" placeholder="Rechercher une épreuve..." type="text" />
</div>
</div>
</section>
...
<span className="bg-secondary-fixed text-on-secondary-fixed text-[10px] font-bold px-2 py-1 rounded-full uppercase">Série C</span>
</div>
...
<div className="subject-card bg-surface border border-outline-variant rounded-xl p-5 transition-all duration-200 flex flex-col group">
<div className="flex justify-between items-start mb-4">
<div className="w-12 h-12 rounded-lg bg-on-primary-container/20 flex items-center justify-center text-primary">
<span className="material-symbols-outlined text-3xl">translate</span>
</div>
<span className="bg-secondary-fixed text-on-secondary-fixed text-[10px] font-bold px-2 py-1 rounded-full uppercase">Série C</span>
</div>
<h3 className="font-headline-md text-headline-md text-on-surface mb-1">Anglais</h3>
<p className="text-label-sm text-on-surface-variant mb-4">LV1 • Compréhension &amp; Essai • 2023</p>
<div className="flex items-center gap-4 mb-6 text-label-xs text-on-surface-variant">
<div className="flex items-center gap-1">
<span className="material-symbols-outlined text-base">timer</span>
<span className="">2 Heures</span>
</div>
<div className="flex items-center gap-1">
<span className="material-symbols-outlined text-base">task</span>
<span className="">20 Questions</span>
</div>
</div>
<div className="mt-auto">
<button className="w-full bg-primary hover:bg-primary-container text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors active:scale-95 duration-100">
...
<h3 className="font-headline-md text-headline-md text-on-surface mb-1">Français</h3>
<p className="text-label-sm text-on-surface-variant mb-4">Littérature &amp; Composition • 2023</p>
<div className="flex items-center gap-4 mb-6 text-label-xs text-on-surface-variant">
<div className="flex items-center gap-1">
<span className="material-symbols-outlined text-base">timer</span>
<span className="">4 Heures</span>
...
<img className="w-full h-full object-cover rounded-2xl shadow-xl" src="/images/ecran-320.png" alt="A high-tech digital illustration showcasing a glowing AI neural network pattern overlaid on top of a stack of academic textbooks. The aesthetic is clean and futuristic with deep Academic Blue tones and sparks of National Orange. The image represents the bridge between traditional study and modern technological assistance, maintaining a sophisticated and professional educational feel." />
</div>
        ...
        searchInput.addEventListener('input', (e) =&gt; &#123;
            ...
            document.querySelectorAll('.subject-card').forEach(card =&gt; &#123;
                ...
                &#125; else &#123;
                    ...
                    // We keep it visible but faded for aesthetic layout consistency in this demo
                &#125;
            &#125;);
        &#125;);
    </script>
