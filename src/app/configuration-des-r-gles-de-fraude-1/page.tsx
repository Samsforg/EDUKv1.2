...
export const metadata: Metadata = { title: "Edukora Admin | Moteur de Règles de Fraude" };
...
<img alt="Edukora Logo" className="h-8 w-8 object-contain" src="/images/ecran-074.png" />
...
<a className="text-on-primary/80 font-medium hover:bg-primary-container/20 transition-colors px-3 py-1 rounded" href="#">Enquêtes</a>
<a className="text-on-primary font-bold underline decoration-secondary decoration-2 px-3 py-1 rounded" href="#">Règles</a>
<a className="text-on-primary/80 font-medium hover:bg-primary-container/20 transition-colors px-3 py-1 rounded" href="#">Audit</a>
</nav>
...
<img className="w-full h-full object-cover" src="/images/ecran-075.png" alt="A professional headshot of a female system administrator" />
</div>
</div>
</header>
...
<p className="font-body text-label-xs text-on-surface-variant">Surveillance Fraude</p>
</div>
</div>
...
<span className="font-body text-body-md">Alertes</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-all duration-200 ease-in-out" href="#">
...
<span className="font-body text-body-md">Règles</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-all duration-200 ease-in-out" href="#">
<span className="material-symbols-outlined">history_edu</span>
<span className="font-body text-body-md">Audit</span>
</a>
</nav>
...
<p className="text-on-surface-variant max-w-2xl">Gérez les seuils de sécurité automatisés et les paramètres de détection pilotés par l'IA pour protéger l'intégrité de la plateforme Edukora.</p>
</header>
...
<h3 className="font-headline text-lg font-bold mb-1">Nombre max d'appareils par compte</h3>
<p className="text-label-sm text-on-surface-variant mb-6">Limite le nombre d'identifiants matériels distincts pouvant accéder à un profil étudiant unique sur une période de 24 heures.</p>
<div className="space-y-4">
<div className="flex justify-between items-center p-3 bg-surface-container rounded-lg">
<span className="text-label-sm font-medium">Limite d'appareils</span>
...
<span className="material-symbols-outlined text-sm">warning</span>
                        Signaler comme haut risque si dépassé
                    </div>
</div>
</section>
...
<div>
<h3 className="font-headline text-lg font-bold mb-1">Seuil de confiance de l'IA</h3>
<p className="text-label-sm text-on-surface-variant mb-6">La probabilité minimale requise pour que le Proctor IA signale une réponse comme potentiellement plagiée ou générée par IA.</p>
...
<p className="text-label-xs leading-tight">Régler ce paramètre au-dessus de 90 % réduit les faux positifs mais peut laisser passer du plagiat sophistiqué.</p>
</div>
</div>
</div>
</section>
...
<h3 className="font-headline text-lg font-bold mb-1">Fréquence de paiement suspecte</h3>
<p className="text-label-sm text-on-surface-variant mb-6">Déclenche un blocage automatique des comptes tentant plusieurs achats d'abonnements de grande valeur dans un court intervalle.</p>
...
<h3 className="font-headline text-lg font-bold mb-1">Vélocité de l'Adresse IP</h3>
<p className="text-label-sm text-on-surface-variant mb-6">Détecte les déplacements impossibles ou le partage de compte en surveillant les changements géographiques des adresses IP d'origine.</p>
...
<option>Bloquer Pays Différents</option>
<option selected={true}>Signaler Ville Différente (&gt;50km)</option>
<option>Ignorer (Log uniquement)</option>
</select>
</section>
...
<h3 className="font-headline text-lg font-bold mb-1">Vitesse de complétion anormale</h3>
<p className="text-label-sm text-on-surface-variant mb-6">Identifie les utilisateurs qui terminent les examens blancs à des vitesses statistiquement improbables pour la lecture et le traitement humain.</p>
<div className="flex items-center gap-3">
<div className="flex-1">
<span className="text-label-xs font-bold text-on-surface-variant">Temps Min %</span>
<div className="flex items-center gap-2">
...
<button className="bg-primary text-on-primary px-4 py-2 rounded-lg text-label-sm font-bold shadow-sm hover:bg-primary-container transition-colors">Ajuster la Référence</button>
</div>
</section>
</div>
...
<h4 className="font-headline text-headline-md font-bold text-white">Sauvegarder les modifications sur le moteur direct ?</h4>
<p className="text-on-primary-container font-medium">Les règles modifiées prendront effet globalement sur toutes les sessions actives immédiatement.</p>
</div>
<div className="relative z-10 flex gap-4">
<button className="px-8 py-3 bg-white text-primary font-bold rounded-xl hover:bg-surface-bright active:scale-95 transition-all">Abandonner</button>
<button className="px-8 py-3 bg-secondary-container text-on-secondary-container font-bold rounded-xl shadow-lg hover:shadow-secondary/20 active:scale-95 transition-all">Mettre à jour le Moteur</button>
</div>
</div>
</main>
