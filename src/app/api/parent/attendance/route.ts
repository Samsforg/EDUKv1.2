...
async function GETHandler(req: NextRequest) {
  ...
  const week = await getWeeklyActivity(child.child_id);
  const peak = await getPeakHours(child.child_id);
...
export const GET = guardApi("GET /api/parent/attendance", GETHandler);
