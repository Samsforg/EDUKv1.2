...
<header className="fixed top-0 w-full z-50 bg-primary dark:bg-primary-container shadow-md flex justify-between items-center px-4 md:px-8 py-3 w-full">
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-on-primary text-3xl" data-icon="security">security</span>
...
<a className="text-on-primary/80 font-medium hover:bg-primary-container/20 transition-colors px-2 py-1 rounded" href="#">Analytics</a>
...
<p className="text-xs text-on-surface-variant uppercase tracking-widest font-semibold">Surveillance de la fraude</p>
</div>
...
<p className="text-[10px] text-on-surface-variant mt-2 text-right">94% uptime</p>
</div>
</aside>
...
<p className="text-on-surface-variant">Real-time fraud oversight and academic integrity monitoring.</p>
</div>
...
<span className="text-xs font-bold text-error bg-error-container/20 px-2 py-1 rounded">+12% vs yesterday</span>
</div>
...
<p className="text-on-surface-variant text-sm font-medium uppercase tracking-wider">Blocked Users (24h)</p>
...
<button className="text-xs font-bold px-3 py-1 bg-surface-container text-on-surface rounded border border-outline-variant">Filtre</button>
...
<span className="text-xs font-bold text-error uppercase">High Priority</span>
<span className="text-xs text-on-surface-variant">• 2 mins ago</span>
</div>
<h4 className="font-bold text-on-surface">Paiement suspect</h4>
<p className="text-sm text-on-surface-variant">User ID: <span className="font-mono text-primary">USR-9283-BAC</span></p>
</div>
</div>
...
<div>
<div className="flex items-center gap-2 mb-1">
<span className="text-xs font-bold text-secondary uppercase">Medium Priority</span>
<span className="text-xs text-on-surface-variant">• 15 mins ago</span>
</div>
<h4 className="font-bold text-on-surface">Partage de compte détecté</h4>
<p className="text-sm text-on-surface-variant">User ID: <span className="font-mono text-primary">USR-4412-BEPC</span></p>
</div>
</div>
...
<div>
<div className="flex items-center gap-2 mb-1">
<span className="text-xs font-bold text-on-surface-variant uppercase">Low Priority</span>
<span className="text-xs text-on-surface-variant">• 1 hour ago</span>
</div>
<h4 className="font-bold text-on-surface">Alerte d'intégrité académique</h4>
<p className="text-sm text-on-surface-variant">User ID: <span className="font-mono text-primary">USR-1055-BAC</span></p>
</div>
</div>
<button className="bg-surface-container-high text-on-surface px-6 py-2 rounded-lg text-sm font-bold active:scale-95 transition-transform flex items-center gap-2">
<span>Investigate</span>
...
<h4 className="font-bold text-on-surface">Comportement de bot dans le simulateur d'examen</h4>
<p className="text-sm text-on-surface-variant">User ID: <span className="font-mono text-primary">USR-7731-BEPC</span></p>
</div>
</div>
<button className="bg-primary text-on-primary px-6 py-2 rounded-lg text-sm font-bold shadow-sm active:scale-95 transition-transform flex items-center gap-2">
<span>Investigate</span>
...
<img className="w-full h-full object-cover" data-location="Abidjan" src="/images/ecran-358.png" alt="A stylized minimalist digital map showing heat concentrations over major cities in Côte d'Ivoire like Abidjan, Yamoussoukro, and Bouaké. The map uses a sophisticated dark blue and slate gray palette with vibrant orange and red glowing heat spots indicating high alert volume areas. Clean, professional UI aesthetics." />
</div>
<div className="space-y-3">
<div className="flex justify-between items-center text-sm">
<span className="text-on-surface-variant">Abidjan</span>
<span className="font-bold text-error">64% of alerts</span>
</div>
...
<span className="font-bold text-secondary">18% of alerts</span>
</div>
<div className="w-full bg-surface-container-high h-1.5 rounded-full">
...
<h3 className="font-bold text-xl mb-1">Efficiency Boost</h3>
<p className="text-on-primary/70 text-sm mb-4">Auto-mitigation has resolved 84 cases today.</p>
<button className="bg-on-primary text-primary px-4 py-2 rounded font-bold text-sm hover:bg-secondary-fixed transition-colors">Voir les journaux</button>
</div>
...
<script>
        ...
        document.querySelectorAll('button').forEach(btn =&gt; &#123;
            btn.addEventListener('click', function(e) &#123;
                if (this.innerText.includes('Investigate')) &#123;
        ...
        setInterval(() =&gt; &#123;
            const kpi = document.querySelector('.text-4xl');
