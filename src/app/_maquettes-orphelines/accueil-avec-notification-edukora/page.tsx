...
export default function Page() {
  return (
    <div className="bg-background text-on-background font-body-md min-h-screen pb-24" style={{ minHeight: "max(884px, 100dvh)" }}><div className="fixed top-4 left-4 right-4 z-[100] animate-in fade-in slide-in-from-top-4 duration-500">
<div className="bg-surface/90 backdrop-blur-md border border-outline-variant rounded-xl p-4 shadow-md flex flex-col gap-2">
<div className="flex items-center justify-between">
<div className="flex items-center gap-2">
<div className="w-6 h-6 bg-primary rounded-lg flex items-center justify-center">
<span className="material-symbols-outlined text-[16px] text-on-primary">school</span>
</div>
<span className="text-label-xs font-bold text-on-surface-variant tracking-wider uppercase">EDUKORA</span>
</div>
<span className="text-label-xs text-on-surface-variant opacity-70">Maintenant</span>
</div>
<div className="space-y-0.5">
<p className="font-label-sm text-on-surface">C'est l'heure de votre session de Maths !</p>
<p className="text-label-xs text-on-surface-variant">3 questions vous attendent pour valider vos acquis du jour.</p>
</div>
<div className="w-12 h-1 bg-outline-variant/30 rounded-full self-center mt-1"></div>
</div>
</div>
