...
<div className="bento-grid mb-stack-lg"><div className="col-span-2 bg-secondary-fixed border border-secondary p-4 rounded-xl shadow-sm flex items-center justify-between">
<div className="flex items-center gap-3">
...
</div><section className="col-span-2 mb-stack-sm">
<div className="flex justify-between items-center mb-stack-sm">
<h3 className="font-label-sm text-label-sm text-on-surface-variant font-bold uppercase tracking-wider">Récompenses de Série</h3>
</div>
...
<img alt="Palier 30 Jours" className="w-full h-full object-contain" src="/images/ecran-289.png" />
</div>
...
<div className="flex-shrink-0 w-32 flex flex-col items-center gap-2 opacity-60">
...
<img alt="Palier 50 Jours" className="w-full h-full object-contain grayscale" src="/images/ecran-290.png" />
...
<div className="flex-shrink-0 w-32 flex flex-col items-center gap-2 opacity-40">
...
<img alt="Palier 100 Jours" className="w-full h-full object-contain grayscale" src="/images/ecran-291.png" />
</div>
<div className="text-center">
...
</div><div className="flex-shrink-0 w-32 flex flex-col items-center gap-2 opacity-40">
<div className="w-24 h-24 rounded-xl bg-surface-container-low border border-outline-variant p-2 shadow-sm flex items-center justify-center">
<img alt="Palier 365 Jours" className="w-full h-full object-contain grayscale" src="/images/ecran-292.png" />
</div>
<div className="text-center">
...
<div className="col-span-2 bg-surface-container-lowest border border-outline-variant p-5 rounded-xl shadow-sm mt-1">
...
<div className="w-16 h-16 rounded-full bg-secondary-fixed border-2 border-secondary flex items-center justify-center"><img alt="Excellence Badge" className="w-full h-full object-cover rounded-full" src="/images/ecran-093.png" /></div>
...
<section className="mb-stack-lg">
<div className="flex justify-between items-center mb-stack-sm">
<h3 className="font-label-sm text-label-sm text-on-surface-variant font-bold uppercase tracking-wider">Défis en cours</h3>
</div>
...
</section><section className="bg-surface-container-low rounded-2xl p-5 border border-outline-variant mb-stack-lg">
