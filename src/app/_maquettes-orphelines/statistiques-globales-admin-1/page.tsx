...
<span className="material-symbols-outlined text-on-primary dark:text-on-primary-fixed text-3xl" style={{"fontVariationSettings":"'FILL' 1"}}>school</span>
...
<a className="text-on-primary-container opacity-80 hover:bg-primary-container transition-colors px-3 py-1 rounded-lg" href="#">Overview</a>
<a className="text-on-primary-container opacity-80 hover:bg-primary-container transition-colors px-3 py-1 rounded-lg" href="#">Users</a>
...
<a className="text-on-primary font-bold hover:bg-primary-container transition-colors px-3 py-1 rounded-lg" href="#">Analytics</a>
</nav>
...
<p className="text-on-surface-variant body-md">Reporting dashboard for academic performance and platform growth.</p>
</div>
<div className="flex bg-surface-container p-1 rounded-xl w-fit">
<button className="px-4 py-2 text-label-sm font-semibold rounded-lg tab-active transition-all duration-200">Last 30 Days</button>
<button className="px-4 py-2 text-label-sm font-semibold rounded-lg text-on-surface-variant hover:bg-surface-container-high transition-all duration-200">Last Quarter</button>
<button className="px-4 py-2 text-label-sm font-semibold rounded-lg text-on-surface-variant hover:bg-surface-container-high transition-all duration-200">Year</button>
</div>
</section>
...
<div>
<span className="text-label-sm font-semibold text-on-surface-variant uppercase tracking-wider">Total Users</span>
...
<span className="text-label-xs text-on-surface-variant">Premium Members</span>
</div>
...
<div>
<span className="text-label-sm font-semibold text-on-surface-variant uppercase tracking-wider">Total Revenue</span>
<div className="flex items-baseline gap-2 mt-1">
...
<span className="text-label-xs text-on-surface-variant">Monthly Target (25M)</span>
...
<span>Projected to exceed target by 12%</span>
</div>
</div>
</section>
...
<h3 className="text-headline-md font-bold text-primary">User Acquisition</h3>
...
<span className="text-label-xs">Students</span>
</div>
<div className="flex items-center gap-2">
...
<div className="bg-surface-container-lowest border border-outline-variant p-6 rounded-xl shadow-sm">
<div className="flex justify-between items-center mb-6">
<h3 className="text-headline-md font-bold text-primary">Content Impact</h3>
<div className="flex gap-2">
<button className="text-label-xs font-bold border border-outline-variant px-3 py-1 rounded-lg">Sheets</button>
<button className="text-label-xs font-bold bg-surface-container px-3 py-1 rounded-lg">Series</button>
</div>
</div>
<div className="space-y-5">
<div className="space-y-1">
<div className="flex justify-between text-label-sm">
<span className="font-medium">Series D: Mathématiques (Terminale)</span>
...
<div className="space-y-1">
<div className="flex justify-between text-label-sm">
<span className="font-medium">Series C: Physique-Chimie</span>
...
<div className="space-y-1">
<div className="flex justify-between text-label-sm">
<span className="font-medium">Series A1: Philosophie</span>
...
<span className="text-label-xs font-bold text-on-surface-variant uppercase block mb-3">Top 5 des fiches d'étude</span>
...
<span className="text-label-xs text-on-surface-variant">12.4k views</span>
</li>
<li className="flex items-center gap-3">
...
<span className="text-label-xs text-on-surface-variant">9.8k views</span>
</li>
</ul>
</div>
</div>
...
<div>
<span className="text-label-xs font-bold text-on-surface-variant uppercase block mb-4">Revenue Sources</span>
...
<p className="text-label-sm font-bold">Monthly Packs</p>
<p className="text-label-xs text-on-surface-variant">65% of total revenue</p>
</div>
...
<div className="flex-1">
<p className="text-label-sm font-bold">Single Exercises</p>
<p className="text-label-xs text-on-surface-variant">22% of total revenue</p>
</div>
...
<span className="text-label-xs font-bold text-on-surface-variant uppercase mb-4">User Retention Rate</span>
<div className="text-4xl font-extrabold text-secondary mb-2">84.2%</div>
<p className="text-label-xs text-on-surface-variant px-4">High satisfaction due to Tuteur IA integration in late Q3.</p>
<button className="mt-4 text-primary text-label-sm font-bold flex items-center gap-1">View Cohorts <span className="material-symbols-outlined text-sm">arrow_forward</span></button>
</div>
</div>
</div>
...
<span className="text-3xl font-bold">54m <small className="text-sm font-medium">/ user</small></span>
</div>
</div>
<div className="pt-6 border-t border-outline-variant">
<div className="text-label-xs font-bold text-on-surface-variant uppercase mb-4">Tuteur IA Interaction</div>
<div className="flex items-center justify-between">
<div className="flex flex-col">
<span className="text-xl font-bold">8.4x</span>
<span className="text-label-xs text-on-surface-variant">Sessions per user</span>
</div>
...
<p className="text-label-xs font-medium italic text-primary-container">"Students interacting with Tuteur IA at least 5x weekly show 30% higher completion rates."</p>
</div>
</div>
</div>
</section>
...
<span className="font-label text-label-xs font-semibold">Overview</span>
</div>
<div className="flex flex-col items-center justify-center text-on-surface-variant dark:text-outline-variant px-3 py-1.5 active:scale-90 transition-all duration-150 cursor-pointer">
<span className="material-symbols-outlined">group</span>
<span className="font-label text-label-xs font-semibold">Users</span>
</div>
<div className="flex flex-col items-center justify-center text-on-surface-variant dark:text-outline-variant px-3 py-1.5 active:scale-90 transition-all duration-150 cursor-pointer">
...
<span className="font-label text-label-xs font-semibold">Analytics</span>
</div>
</footer>
