...
<div className="toggle-switch exam-bepc" id="exam-toggle">
...
<div className="mb-stack-sm transition-opacity duration-300 opacity-30 pointer-events-none" id="series-filter-container">
...
<h2 className="font-headline-md text-headline-md text-on-surface mb-stack-md" id="section-title">Explorateur de Matières - BEPC &amp; Options</h2>
<div className="grid grid-cols-1 gap-4" id="course-container"><div className="course-card bg-surface border border-outline-variant rounded-xl p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform duration-200"><div className="flex justify-between items-start"><div className="flex items-center gap-3"><div className="w-12 h-12 rounded-lg bg-secondary-fixed flex items-center justify-center"><span className="material-symbols-outlined text-on-secondary-fixed" style={{"fontVariationSettings":"'FILL' 1"}}>edit_note</span></div><div><h3 className="font-headline-md text-[18px] text-on-surface">Français</h3><p className="text-on-surface-variant font-label-xs">16 Leçons • Dictée &amp; Rédaction</p></div></div><div className="bg-tertiary-fixed text-on-tertiary-fixed px-2 py-1 rounded font-label-xs">BEPC</div></div><div className="mt-2"><div className="flex justify-between items-center mb-1"><span className="font-label-xs text-on-surface-variant">Progression</span><span className="font-label-xs text-primary">0%</span></div><div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden"><div className="bg-secondary-container h-full rounded-full" style={{"width":"0%"}}></div></div></div></div><div className="course-card bg-surface border border-outline-variant rounded-xl p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform duration-200"><div className="flex justify-between items-start"><div className="flex items-center gap-3"><div className="w-12 h-12 rounded-lg bg-primary-container flex items-center justify-center"><span className="material-symbols-outlined text-on-primary-container" style={{"fontVariationSettings":"'FILL' 1"}}>calculate</span></div><div><h3 className="font-headline-md text-[18px] text-on-surface">Mathématiques</h3><p className="text-on-surface-variant font-label-xs">14 Leçons • Arithmétique &amp; Géométrie</p></div></div><div className="bg-tertiary-fixed text-on-tertiary-fixed px-2 py-1 rounded font-label-xs">BEPC</div></div><div className="mt-2"><div className="flex justify-between items-center mb-1"><span className="font-label-xs text-on-surface-variant">Progression</span><span className="font-label-xs text-primary">0%</span></div><div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden"><div className="bg-secondary-container h-full rounded-full" style={{"width":"0%"}}></div></div></div></div><h3 className="font-label-xs text-on-surface-variant font-semibold mt-4 ml-1 uppercase tracking-wider">Langue Vivante 2</h3><div className="course-card bg-surface border border-outline-variant rounded-xl p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform duration-200"><div className="flex justify-between items-start"><div className="flex items-center gap-3"><div className="w-12 h-12 rounded-lg bg-secondary-container flex items-center justify-center"><span className="material-symbols-outlined text-white" style={{"fontVariationSettings":"'FILL' 1"}}>language</span></div><div><h3 className="font-headline-md text-[18px] text-on-surface">Allemand (LV2)</h3><p className="text-on-surface-variant font-label-xs">12 Leçons • Langue Vivante 2</p></div></div><div className="bg-tertiary-fixed text-on-tertiary-fixed px-2 py-1 rounded font-label-xs">BEPC</div></div><div className="mt-2"><div className="flex justify-between items-center mb-1"><span className="font-label-xs text-on-surface-variant">Progression</span><span className="font-label-xs text-primary">0%</span></div><div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden"><div className="bg-secondary-container h-full rounded-full" style={{"width":"0%"}}></div></div></div></div><div className="course-card bg-surface border border-outline-variant rounded-xl p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform duration-200"><div className="flex justify-between items-start"><div className="flex items-center gap-3"><div className="w-12 h-12 rounded-lg bg-secondary-container flex items-center justify-center"><span className="material-symbols-outlined text-white" style={{"fontVariationSettings":"'FILL' 1"}}>translate</span></div><div><h3 className="font-headline-md text-[18px] text-on-surface">Espagnol (LV2)</h3><p className="text-on-surface-variant font-label-xs">12 Leçons • Langue Vivante 2</p></div></div><div className="bg-tertiary-fixed text-on-tertiary-fixed px-2 py-1 rounded font-label-xs">BEPC</div></div><div className="mt-2"><div className="flex justify-between items-center mb-1"><span className="font-label-xs text-on-surface-variant">Progression</span><span className="font-label-xs text-primary">0%</span></div><div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden"><div className="bg-secondary-container h-full rounded-full" style={{"width":"0%"}}></div></div></div></div><h3 className="font-label-xs text-on-surface-variant font-semibold mt-4 ml-1 uppercase tracking-wider">Options Facultatives</h3><div className="course-card bg-surface border border-outline-variant rounded-xl p-4 flex flex-col gap-3 active:scale-[0.98] transition-transform duration-200"><div className="flex justify-between items-start"><div className="flex items-center gap-3"><div className="w-12 h-12 rounded-lg bg-secondary-fixed-dim flex items-center justify-center"><span className="material-symbols-outlined text-on-secondary-fixed-variant" style={{"fontVariationSettings":"'FILL' 1"}}>palette</span></div><div><h3 className="font-headline-md text-[18px] text-on-surface">Arts Plastiques</h3><p className="text-on-surface-variant font-label-xs">8 Leçons • Option Facultative</p></div></div><div className="bg-tertiary-fixed text-on-tertiary-fixed px-2 py-1 rounded font-label-xs">BEPC</div></div><div className="mt-2"><div className="flex justify-between items-center mb-1"><span className="font-label-xs text-on-surface-variant">Progression</span><span className="font-label-xs text-primary">0%</span></div><div className="w-full bg-surface-container-highest h-2 rounded-full overflow-hidden"><div className="bg-secondary-container h-full rounded-full" style={{"width":"0%"}}></div></div></div></div></div>
