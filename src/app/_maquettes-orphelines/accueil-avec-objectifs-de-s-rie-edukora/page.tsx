...
<main className="pt-20 px-margin-mobile space-y-stack-lg space-y-10">
...
<button className="col-span-2 bento-card relative overflow-hidden bg-primary p-5 rounded-xl text-on-primary flex flex-col justify-between h-40 shadow-md active:scale-95 duration-200 h-48" style={{"transform":"scale(1)"}}>
...
<div className="col-span-2 space-y-stack-md"><div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 flex items-center gap-4 shadow-sm"><div className="w-12 h-12 flex-shrink-0"><img alt="Badge" className="w-full h-full object-contain" src="/images/ecran-003.png" /></div><div className="flex-1"><div className="flex justify-between items-center"><h4 className="font-bold text-on-surface">Série de 30 Jours</h4><span className="text-label-sm text-primary">7/30 jrs</span></div><div className="h-1.5 bg-outline-variant rounded-full mt-1"><div className="bg-primary h-full w-[23%] rounded-full"></div></div></div></div></div>
</section>
