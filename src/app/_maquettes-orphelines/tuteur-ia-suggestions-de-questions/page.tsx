...
<h3 className="font-label-sm text-on-surface-variant px-1">Questions suggérées</h3>
<div className="flex flex-wrap gap-2">
<button className="px-4 py-2 bg-surface border border-outline-variant rounded-full text-sm font-label-sm text-on-surface hover:bg-surface-container-low transition-all active:scale-95">
...
<button className="px-4 py-2 bg-surface border border-outline-variant rounded-full text-sm font-label-sm text-on-surface hover:bg-surface-container-low transition-all active:scale-95">
      Dates clés de la décolonisation
    </button>
<button className="px-4 py-2 bg-surface border border-outline-variant rounded-full text-sm font-label-sm text-on-surface hover:bg-surface-container-low transition-all active:scale-95">
