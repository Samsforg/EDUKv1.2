...
<img className="w-full h-full object-cover" src="/images/ecran-288.png" alt="A professional studio portrait of a young Ivorian student with a confident and friendly expression." />
</div>
...
<span className="font-body-md text-body-md">Rappels de Révision</span>
</div>
<span className="material-symbols-outlined text-outline">chevron_right</span>
</button>
<button className="w-full flex items-center justify-between p-4 bg-surface rounded-xl hover:bg-surface-container-high transition-colors text-on-surface">
