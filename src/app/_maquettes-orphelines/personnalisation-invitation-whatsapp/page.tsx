...
<div className="mb-8 bg-surface-container-low p-6 rounded-xl border border-surface-border">
<label className="block font-title-md text-primary mb-3">Message personnalisé</label>
<textarea className="w-full p-4 rounded-lg border border-surface-border font-body-md text-on-surface focus:ring-2 focus:ring-primary focus:border-transparent outline-none min-h-[120px] mb-4" placeholder="Écrivez votre message ici...">Bonjour ! Je fais partie du réseau d'experts Edukora et je pense que ton expertise serait un atout majeur pour certifier nos fiches de révision. Rejoins-nous ici : https://edukora.com/expert/ref/jdoe</textarea>
<div className="flex flex-col gap-2">
<span className="font-label-md text-on-surface-variant">Variables rapides :</span>
<div className="flex flex-wrap gap-2">
<button className="px-3 py-1.5 bg-white border border-surface-border rounded-full font-label-md text-primary hover:bg-primary/5 transition-colors">[Nom du Collège]</button>
<button className="px-3 py-1.5 bg-white border border-surface-border rounded-full font-label-md text-primary hover:bg-primary/5 transition-colors">[Ma Discipline]</button>
<button className="px-3 py-1.5 bg-white border border-surface-border rounded-full font-label-md text-primary hover:bg-primary/5 transition-colors">[Prénom]</button>
</div>
</div>
</div><div className="relative w-full max-w-sm mx-auto bg-inverse-surface rounded-[3rem] p-3 shadow-2xl border-4 border-surface-container-highest"><div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-primary text-white px-4 py-1 rounded-full font-label-md shadow-md z-10">Aperçu en direct</div>
