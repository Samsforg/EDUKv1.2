...
</div><div className="notification-card bg-white border border-surface-border rounded-xl p-4 md:p-6 flex gap-4 md:gap-6 items-start relative overflow-hidden group hover:bg-surface-container-low cursor-pointer">
<div className="absolute left-0 top-0 bottom-0 w-1 bg-primary"></div>
<div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-primary-container flex items-center justify-center flex-shrink-0">
<span className="material-symbols-outlined text-on-primary-container text-[32px]">card_giftcard</span>
</div>
<div className="flex-1">
<div className="flex justify-between items-start mb-1">
<h3 className="font-title-md text-title-md text-on-surface font-bold">Parrainage réussi</h3>
<span className="font-label-md text-label-md text-outline">À l'instant</span>
</div>
<p className="font-body-md text-body-md text-on-surface-variant mb-3 leading-relaxed">
<span className="font-bold text-on-surface">Moussa</span> a rejoint l'aventure ! <span className="text-impact-emerald font-bold">+7 jours Premium</span> ajoutés à votre compte.
</p>
<div className="flex items-center gap-3">
<button className="text-primary font-bold font-label-md text-label-md hover:underline">Voir mon abonnement</button>
</div>
</div>
