...
<button className="flex-1 py-2.5 rounded-full text-label-sm font-bold transition-all duration-200" id="btn-bepc">
                    BEPC
                </button>
<button className="flex-1 py-2.5 rounded-full text-label-sm font-bold transition-all duration-200 segmented-control-active" id="btn-bac">
                    BAC
                </button>
</div>
</section>
...
<p className="font-body-md text-body-md text-on-surface-variant max-w-xl" id="hero-subtitle">
                        Sélectionnez une matière pour commencer votre simulateur d'examen BAC. Désormais disponible pour les séries <strong>A1, A2, C, D (Général)</strong> et <strong>G2, B (Technique)</strong>.
                    </p>
</div>
...
<div className="subject-card bac-card bg-surface border border-outline-variant rounded-xl p-5 transition-all duration-200 flex flex-col group" data-exam="BAC" data-series="C, D">
...
<div className="subject-card bac-card bg-surface border border-outline-variant rounded-xl p-5 transition-all duration-200 flex flex-col group" data-exam="BAC" data-series="G2">
<div className="flex justify-between items-start mb-4">
...
<div className="subject-card bac-card bg-surface border border-outline-variant rounded-xl p-5 transition-all duration-200 flex flex-col group" data-exam="BAC" data-series="B">
<div className="flex justify-between items-start mb-4">
...
<div className="subject-card bepc-card hidden bg-surface border border-outline-variant rounded-xl p-5 transition-all duration-200 flex flex-col group" data-exam="BEPC">
<div className="flex justify-between items-start mb-4">
<div className="w-12 h-12 rounded-lg bg-primary-fixed flex items-center justify-center text-primary">
