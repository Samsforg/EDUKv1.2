...
export const metadata: Metadata = { title: "Console de support Edukora - Subscription Tickets" };
...
<span className="material-symbols-outlined text-display-lg-mobile" style={{"fontVariationSettings":"'FILL' 1"}}>admin_panel_settings</span>
...
<img className="w-full h-full object-cover" src="/images/ecran-156.png" alt="A professional headshot of a West African male support lead wearing a sharp navy blue blazer, smiling warmly against a blurred corporate office background. The lighting is bright and clean, emphasizing a high-trust, expert persona aligned with the Edukora Academic Blue color scheme." />
</div>
</div>
</header>
...
<p className="text-[10px] text-on-surface-variant">Level 3 Access</p>
</div>
</div>
</div>
...
<p className="text-[10px] text-on-surface-variant mt-2 text-right">65% Capacity</p>
</div>
</div>
</aside>
...
<span className="text-primary font-semibold">Subscription Tickets</span>
</nav>
<h2 className="font-headline text-display-lg-mobile md:text-display-lg text-primary">File des tickets</h2>
</div>
...
<div>
<p className="text-label-xs text-on-surface-variant">Unresolved</p>
...
<div>
<p className="text-label-xs text-on-surface-variant">Terminé</p>
...
<input className="bg-transparent border-none focus:ring-0 text-body-md w-48 md:w-64 placeholder:text-outline" placeholder="Search by ID or Name..." type="text" />
</div>
...
<tr>
<th className="px-6 py-4 border-b border-outline-variant">Ticket ID</th>
<th className="px-6 py-4 border-b border-outline-variant">User</th>
<th className="px-6 py-4 border-b border-outline-variant">Issue Description</th>
<th className="px-6 py-4 border-b border-outline-variant">Catégorie</th>
<th className="px-6 py-4 border-b border-outline-variant">Date Submitted</th>
...
<td className="px-6 py-4 text-body-md text-on-surface max-w-xs truncate">Double charge on Wave subscription</td>
<td className="px-6 py-4">
...
<td className="px-6 py-4 text-label-sm text-on-surface-variant">Today, 09:42 AM</td>
<td className="px-6 py-4">
<span className="px-3 py-1 bg-secondary-container/20 text-secondary font-bold text-[11px] rounded-full uppercase border border-secondary/30">Open</span>
</td>
...
<td className="px-6 py-4 text-body-md text-on-surface max-w-xs truncate">Video lesson not loading on PWA</td>
<td className="px-6 py-4">
<span className="px-2.5 py-1 bg-surface-container-highest rounded-full text-label-xs font-bold text-on-surface-variant">Technical</span>
</td>
<td className="px-6 py-4 text-label-sm text-on-surface-variant">Yesterday, 14:15 PM</td>
<td className="px-6 py-4">
<span className="px-3 py-1 bg-primary/10 text-primary font-bold text-[11px] rounded-full uppercase border border-primary/30">In Progress</span>
</td>
<td className="px-6 py-4 text-right">
<button className="text-primary hover:bg-primary/10 p-2 rounded-full transition-colors">
<span className="material-symbols-outlined">visibility</span>
...
<td className="px-6 py-4 text-body-md text-on-surface max-w-xs truncate">Mot de passe oublié, e-mail non reçu</td>
<td className="px-6 py-4">
...
<td className="px-6 py-4">
<span className="px-3 py-1 bg-tertiary-container/10 text-tertiary font-bold text-[11px] rounded-full uppercase border border-tertiary/30">Resolved</span>
</td>
<td className="px-6 py-4 text-right">
<button className="text-primary hover:bg-primary/10 p-2 rounded-full transition-colors">
<span className="material-symbols-outlined">visibility</span>
...
<td className="px-6 py-4 text-body-md text-on-surface max-w-xs truncate">Orange Money transaction failed but debited</td>
<td className="px-6 py-4">
<span className="px-2.5 py-1 bg-surface-container-highest rounded-full text-label-xs font-bold text-on-surface-variant">Facturation</span>
</td>
...
<p className="text-label-xs text-on-surface-variant">Showing <span className="font-bold text-on-surface">1 - 4</span> of 166 tickets</p>
...
<script>
        ...
        document.querySelectorAll('tbody tr').forEach(row =&gt; &#123;
            row.addEventListener('click', () =&gt; &#123;
                // In a real app, this would navigate to ticket details
