...
<button disabled title="Connexion Google bientôt disponible" className="flex items-center justify-center gap-2 py-2.5 px-4 border border-outline-variant rounded-lg font-body-md font-bold disabled:opacity-50 cursor-not-allowed" type="button">
...
<button disabled title="Connexion Apple bientôt disponible" className="flex items-center justify-center gap-2 py-2.5 px-4 border border-outline-variant rounded-lg font-body-md font-bold disabled:opacity-50 cursor-not-allowed" type="button">
...
<p className="font-body-md text-on-surface-variant">
                    Nouveau sur Edukora ? 
                    <Link className="text-primary font-bold hover:underline" href="/inscription-1-2-edukora">Créer un compte</Link>
</p>
</div>
</form>
