...
<span className="text-primary-fixed-dim hover:bg-primary-container/20 transition-colors cursor-pointer px-2 py-1 rounded">Overview</span>
<span className="text-primary-fixed-dim hover:bg-primary-container/20 transition-colors cursor-pointer px-2 py-1 rounded">Users</span>
</div>
...
<img className="w-full h-full object-cover" src="/images/ecran-317.png" alt="A professional headshot of a senior West African male administrator in a clean office setting, wearing a sharp navy blue suit. The lighting is soft and natural, emphasizing competence and authority. The background shows a hint of a modern educational campus in Abidjan with academic blue accents." />
</div>
</div>
</header>
...
<p className="text-on-surface-variant text-label-xs">Institutional Control</p>
</div>
</div>
</div>
...
<span className="font-body text-body-md font-medium">Overview</span>
</a>
<a className="text-on-surface-variant hover:bg-surface-container-high rounded-lg mx-2 my-1 px-4 py-3 flex items-center gap-3 active:translate-x-1 duration-200" href="#">
<span className="material-symbols-outlined">group</span>
<span className="font-body text-body-md font-medium">Users</span>
</a>
<a className="text-on-surface-variant hover:bg-surface-container-high rounded-lg mx-2 my-1 px-4 py-3 flex items-center gap-3 active:translate-x-1 duration-200" href="#">
...
<p className="text-label-xs font-semibold text-primary mb-2">SYSTEM STATUS</p>
...
<div>
<p className="text-label-xs text-on-surface-variant mb-1">État du chiffrement</p>
...
<div>
<p className="text-label-xs text-on-surface-variant mb-1">Last Full Backup</p>
...
<p className="text-label-xs text-on-surface-variant mb-4">Enforcement level across staff</p>
...
<p className="text-label-xs text-on-surface-variant mb-4">Real-time analysis active</p>
...
<button className="bg-error text-on-error text-label-xs font-bold px-3 py-1.5 rounded-lg hover:bg-error/90 active:scale-95 transition-all">Revoke</button>
</div>
</div>
</div>
</div>
...
<h2 className="font-headline font-bold text-on-surface">Journaux d'Audit</h2>
</div>
<div className="flex gap-2">
...
<p className="text-[10px] text-on-surface-variant">Reason: Academic Misconduct</p>
</td>
<td className="px-6 py-4"><span className="px-2 py-0.5 bg-error-container text-on-error-container text-[10px] font-bold rounded">Access</span></td>
...
<td className="px-6 py-4">
<p className="text-label-sm font-bold text-on-surface">Course math-01 modified by Prof. Kouassi</p>
<p className="text-[10px] text-on-surface-variant">Updated: Module 4 Video Link</p>
</td>
<td className="px-6 py-4"><span className="px-2 py-0.5 bg-primary-fixed text-on-primary-fixed text-[10px] font-bold rounded">Content</span></td>
<td className="px-6 py-4"><span className="material-symbols-outlined text-tertiary text-sm">done_all</span></td>
</tr>
<tr className="hover:bg-surface-container-low transition-colors">
...
<p className="text-[10px] text-on-surface-variant">Auto-scheduled maintenance</p>
</td>
<td className="px-6 py-4"><span className="px-2 py-0.5 bg-secondary-fixed text-on-secondary-fixed text-[10px] font-bold rounded">System</span></td>
<td className="px-6 py-4"><span className="material-symbols-outlined text-tertiary text-sm">done_all</span></td>
</tr>
</tbody>
</table>
...
<p className="text-body-md font-bold text-on-surface">IP Whitelisting</p>
...
<div className="flex items-start justify-between gap-4">
<div className="flex-1">
<p className="text-body-md font-bold text-on-surface">Geofencing CI Only</p>
...
<div>
<p className="text-label-xs font-bold text-secondary uppercase tracking-wider">Warning Context</p>
<p className="text-label-xs text-on-secondary-container mt-1">La désactivation du Geofencing augmentera la surface d'attaque de 40%.</p>
</div>
</div>
</div>
</section>
...
<script>
        ...
        // Toggle handling for mobile nav (if needed)
        // Since we have a sidebar for desktop and header for mobile (as per rule PLATFORM &amp; LAYOUT)
    </script>
