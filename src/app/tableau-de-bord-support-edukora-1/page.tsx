...
<img alt="Edukora Logo" className="h-10 w-10 object-contain rounded-lg bg-white p-1" src="/images/ecran-367.png" />
...
<span className="bg-secondary-container/20 text-on-secondary-container text-label-xs px-2 py-0.5 rounded-full font-semibold">Accès Niveau 3</span>
</div>
...
<span>Tickets d'Abonnement</span>
</a>
<a className="flex items-center gap-3 px-6 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-full mx-2 transition-all" href="#">
<span className="material-symbols-outlined">receipt_long</span>
<span>Vérification Facturation</span>
</a>
<a className="flex items-center gap-3 px-6 py-3 text-on-surface-variant hover:bg-surface-container-high rounded-full mx-2 transition-all" href="#">
...
<div>
<h2 className="font-headline text-display-lg-mobile md:text-display-lg text-primary">Vue d'Ensemble</h2>
<p className="text-on-surface-variant">Surveillance des opérations de support en temps réel.</p>
</div>
<div className="relative w-full md:w-96 group">
<span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline">search</span>
<input className="w-full pl-12 pr-4 py-3 bg-surface-container-lowest border border-outline-variant rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Rechercher des tickets, IDs, ou étudiants..." type="text" />
</div>
</div>
...
<div>
<p className="text-on-surface-variant text-label-sm font-medium mb-1">Total des Tickets</p>
...
<div className="bg-surface-container-lowest border border-outline-variant p-6 rounded-xl flex items-center justify-between shadow-sm">
<div>
<p className="text-on-surface-variant text-label-sm font-medium mb-1">Problèmes d'Abonnement</p>
...
<div className="bg-surface-container-lowest border border-outline-variant p-6 rounded-xl flex items-center justify-between shadow-sm">
<div>
<p className="text-on-surface-variant text-label-sm font-medium mb-1">Temps de Résolution Moyen</p>
...
<h2 className="font-headline text-headline-md font-semibold">Tickets Prioritaires</h2>
</div>
<button className="text-primary font-semibold text-label-sm hover:underline">Voir tous les Tickets</button>
</div>
...
<span className="bg-error-container text-on-error-container text-label-xs px-2 py-1 rounded-md font-bold uppercase">PRIORITÉ HAUTE</span>
</div>
<h4 className="font-headline font-bold text-lg mb-1">Abonnement non activé</h4>
<p className="text-on-surface-variant text-body-md mb-6">L'utilisateur a payé via Mobile Money mais l'accès premium BAC est toujours verrouillé.</p>
...
<p className="text-label-xs text-outline">Étudiant (BAC-S)</p>
</div>
...
<p className="text-on-surface-variant text-body-md mb-6">L'étudiant ne peut pas passer l'écran de vérification après un changement d'e-mail.</p>
<div className="flex items-center gap-3 border-t border-outline-variant pt-4">
...
<p className="text-label-xs text-outline">Étudiant (BEPC)</p>
</div>
<button className="bg-primary text-on-primary p-2 rounded-lg hover:bg-primary-container transition-colors">
<span className="material-symbols-outlined">launch</span>
</button>
...
<span className="bg-secondary-fixed text-on-secondary-fixed text-label-xs px-2 py-1 rounded-md font-bold uppercase">PRIORITÉ MOYENNE</span>
</div>
<h4 className="font-headline font-bold text-lg mb-1">Score du Quiz non sauvegardé</h4>
<p className="text-on-surface-variant text-body-md mb-6">Quiz d'histoire terminé mais la barre de progression reste à 40%.</p>
<div className="flex items-center gap-3 border-t border-outline-variant pt-4">
...
<p className="text-label-xs text-outline">Étudiant (BAC-L)</p>
</div>
<button className="bg-primary text-on-primary p-2 rounded-lg hover:bg-primary-container transition-colors">
<span className="material-symbols-outlined">launch</span>
</button>
...
<h3 className="font-headline font-bold text-lg mb-6">Journal d'Activité Récente</h3>
...
<div>
<p className="text-body-md"><span className="font-bold">Jean-Luc B.</span> a résolu <span className="font-bold text-primary">#TK-8840</span> (Litige de Facturation)</p>
<p className="text-label-xs text-outline">Il y a 2 minutes</p>
</div>
</div>
...
<div>
<p className="text-body-md">L'IA Système a envoyé une réponse automatique à <span className="font-bold text-primary">#TK-8855</span></p>
<p className="text-label-xs text-outline">Il y a 15 minutes</p>
</div>
</div>
<div className="flex items-start gap-4 p-3 hover:bg-surface-container transition-colors rounded-lg">
...
<div>
<p className="text-body-md">Nouveau ticket de priorité haute assigné : <span className="font-bold text-primary">#TK-8856</span></p>
<p className="text-label-xs text-outline">Il y a 42 minutes</p>
</div>
</div>
</div>
</div>
...
<div>
<h3 className="font-headline font-bold text-lg mb-2">Capacité de l'Équipe</h3>
<p className="text-on-primary/70 text-label-sm mb-6">La charge actuelle par agent est élevée. Envisagez d'activer l'IA de débordement.</p>
<div className="space-y-4">
<div>
